...
void ClapTrap::attack(const std::string &target)
{
    ...
    std::cout << this->_type << " " << this->get_name() << " attacks " << target << ", causing "
...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    {
        std::cout << this->_type << " " << this->get_name() << " is dead!" << std::endl;
        return;
    }

    std::cout << this->_type << " " << this->get_name() << " take " << amount << " points of damage!"
              << std::endl;
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    std::cout << this->_type << " " << this->_name << " repair " << amount << " points of damage!"
              << std::endl;
...
bool ClapTrap::status(void)
{
    ...
    {
        std::cout << this->_type << " " << this->_name << " is exhausted!" << std::endl;
        return false;
    }
